...
Python scripts to perform 1D and 2D deconvolution.
  ...
  :HISTORY:
    ...
    2018-06-29 11:39 IJMC: Now Python3 compliant.
"""
...
from numpy import sum, array, arange, linalg, tile, concatenate, floor, ones, zeros, dot, meshgrid
#from pylab import find, figure, plot, subplot, grid, legend, title, show, inv, colorbar, clim, imshow, meshgrid
from  matplotlib.pyplot import figure, plot, subplot, grid, legend, title, show, colorbar, clim, imshow
