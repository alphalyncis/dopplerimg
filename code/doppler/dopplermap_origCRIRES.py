...
for jj in range(nchips): # EB: chip 0-3
    for kk in range(nobs): # EB: frame 0-13
        ...
        m,kerns[kk,jj],b,c = dia.dsa(deltaspec, obs1[kk,jj], nk)#/chipcors[kk,jj], nk)    # EB: DSA=Difference Spectral Analysis. Match given spectra to reference spectra
...
fig.savefig('map_WISE1049B_CRIRES_25Nov22.png', overwrite=True)
